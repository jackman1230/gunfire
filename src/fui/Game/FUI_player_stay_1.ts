...
module fui.Game {
	...
	export class FUI_player_stay_1 extends fairygui.GComponent {
		...
		public static createInstance():FUI_player_stay_1 {
			return <FUI_player_stay_1><any>(fairygui.UIPackage.createObject("Game","player_stay_1"));
		}
