package zpp_nape.callbacks
{
   ...
   public class ZPP_OptionType
   {
      ...
      {
         return param1 == null?new OptionType():!!Std.§is§(param1,OptionType)?param1:new OptionType().including(param1);
      }
      ...
      {
         return Boolean(nonemptyintersection(param1,includes));
      }
      
      public function excluded(param1:ZNPList_ZPP_CbType) : Boolean
      {
         return Boolean(nonemptyintersection(param1,excludes));
      }
      ...
      public function append(param1:ZNPList_ZPP_CbType, param2:*) : void
      {
         ...
         if(Std.§is§(param2,CbType))
         {
            _loc3_ = param2;
            append_type(param1,_loc3_.zpp_inner);
         }
         else if(Std.§is§(param2,CbTypeList))
         {
            _loc4_ = param2;
         ...
         else if(Std.§is§(param2,ZPP_Const.cbtypevector))
         {
            _loc6_ = param2;
            _loc7_ = 0;
