...
export default class WXFUI_ADListView extends fairygui.GComponent {
	...
	public m_ad_1:WXFUI_ADListHorBig;
	public m_ad_2:WXFUI_ADListHorBig;
	...
	protected onConstruct(): void {
		...
		this.m_ad_1 = <WXFUI_ADListHorBig><any>(this.getChild("ad_1"));
		this.m_ad_2 = <WXFUI_ADListHorBig><any>(this.getChild("ad_2"));
