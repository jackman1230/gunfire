(function () {
    ...
    class WXFUI_ttTops extends fgui.GComponent {
        static createInstance() {
            return (fgui.UIPackage.createObject("Game", "ttTops"));
        }
        onConstruct() {
    ...
    WXFUI_ttTops.URL = "ui://bq3h5insk6saxwr";
    ...
    class GameBinder {
        static bindAll() {
            ...
            fgui.UIObjectFactory.setExtension(WXFUI_ttTops.URL, WXFUI_ttTops);
