...
export default class WXFUI_PlayerInfoView extends fairygui.GComponent {
	...
	protected onConstruct(): void {
		this.m_blood_1 = <WXFUI_blood><any>(this.getChild("blood_1"));
		this.m_blood_2 = <WXFUI_blood><any>(this.getChild("blood_2"));
		this.m_blood_3 = <WXFUI_blood><any>(this.getChild("blood_3"));
		...
		this.m_item_1 = <WXFUI_GoodsItem><any>(this.getChild("item_1"));
		this.m_item_2 = <WXFUI_GoodsItem><any>(this.getChild("item_2"));
		this.m_item_3 = <WXFUI_GoodsItem><any>(this.getChild("item_3"));
	}
}