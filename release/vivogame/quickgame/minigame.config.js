...
module.exports = function (options) {
  ...
  const externals = [
	{
		module_name:'./js/bundle-bb1e4439f6.js',
		module_path:'./js/bundle-bb1e4439f6.js',
		module_from:'engine/js/bundle-bb1e4439f6.js'
	},
	{
	...
	{
		module_name:'./libs/laya.ani.min.js',
		module_path:'./libs/laya.ani.min.js',
		module_from:'engine/libs/laya.ani.min.js'
	},
	{
		module_name:'./libs/laya.core.min.js',
		module_path:'./libs/laya.core.min.js',
		module_from:'engine/libs/laya.core.min.js'
	},
	{
		module_name:'./libs/laya.html.min.js',
		module_path:'./libs/laya.html.min.js',
		module_from:'engine/libs/laya.html.min.js'
	},
	{
		module_name:'./libs/laya.physics.min.js',
		module_path:'./libs/laya.physics.min.js',
		module_from:'engine/libs/laya.physics.min.js'
	},
	{
		module_name:'./libs/laya.ui.min.js',
		module_path:'./libs/laya.ui.min.js',
		module_from:'engine/libs/laya.ui.min.js'
	},
	{
	...
	{
		module_name:'./libs/moosnow.conf.js',
		module_path:'./libs/moosnow.conf.js',
		module_from:'engine/libs/moosnow.conf.js'
	},
	{
		module_name:'./libs/moosnow.platform.sdk.min.js',
		module_path:'./libs/moosnow.platform.sdk.min.js',
		module_from:'engine/libs/moosnow.platform.sdk.min.js'
	}	]
