package nape.dynamics
{
   ...
   public class Arbiter
   {
      ...
      public function toString() : String
      {
         ...
         §§push(_loc1_ + "(" + (zpp_inner.ws1.id > zpp_inner.ws2.id?zpp_inner.ws2.outer:zpp_inner.ws1.outer).toString() + "|" + (zpp_inner.ws1.id > zpp_inner.ws2.id?zpp_inner.ws1.outer:zpp_inner.ws2.outer).toString() + ")" + (!!isCollisionArbiter()?"[" + ["SD","DD"][!!zpp_inner.colarb.stat?0:1] + "]":"") + "<-");
