package zpp_nape.util
{
   ...
   public class ZPP_Flags
   {
      ...
      public static var id_ValidationResult_DEGENERATE_EDGES:int = 2;
      
      public static var id_ValidationResult_CONCAVE:int = 3;
      
      public static var id_ValidationResult_SELF_INTERSECTING:int = 4;
