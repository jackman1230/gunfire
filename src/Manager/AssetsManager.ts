...
export class AssetsManager {
    ...
    public loadAssetsData() {
        AssetsManager.assetsData.push(
            ...
            { url: "sound/BombDrop.mp3", type: Laya.Loader.SOUND },
            { url: "sound/boom.mp3", type: Laya.Loader.SOUND },
            { url: "sound/btn_click.mp3", type: Laya.Loader.SOUND },
            { url: "sound/btn_press.mp3", type: Laya.Loader.SOUND },
            { url: "sound/die_1.mp3", type: Laya.Loader.SOUND },
            { url: "sound/die_2.mp3", type: Laya.Loader.SOUND },
            { url: "sound/die_3.mp3", type: Laya.Loader.SOUND },
            { url: "sound/die_4.mp3", type: Laya.Loader.SOUND },
            { url: "sound/enemy_fire.mp3", type: Laya.Loader.SOUND },
            { url: "sound/gameOver.mp3", type: Laya.Loader.SOUND },
            { url: "sound/get_goods.mp3", type: Laya.Loader.SOUND },
            { url: "sound/obstacleBoom.mp3", type: Laya.Loader.SOUND },
            { url: "sound/obstacleBoom2.mp3", type: Laya.Loader.SOUND },
            { url: "sound/tank_fire.mp3", type: Laya.Loader.SOUND },
            { url: "sound/weapon_1.mp3", type: Laya.Loader.SOUND },
            { url: "sound/weapon_2.mp3", type: Laya.Loader.SOUND },
            { url: "sound/weapon_3.mp3", type: Laya.Loader.SOUND },
            { url: "sound/weapon_10.mp3", type: Laya.Loader.SOUND },
            { url: "sound/chapterBgm.mp3", type: Laya.Loader.SOUND }
        );
